...
print(characters[1])        #prints the first character in characters list
print("------------")       #prints a line of dashes
for item in cat_in:         #prints each item in the list on its own line
    print(item)

print("")       #add a blank line between the characters


print(characters[2])        #prints the first character in characters list
print("------------")       #prints a line of dashes
for item in hamster_in:         #prints each item in the list on its own line
    print(item)
