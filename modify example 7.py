...
def add_char():
    ...
    index = characters.index(to_add)                            #gets the index of the new character
    num_items = int(input("How many items are in the character's inventory?: "))    #ask how many items character has
...
def remove_item():
    """ask a question and then remove an item from a character's inventory"""
    index = choose_char()       #This runs code to ask to choose a character and gets its index
    print("This is your character's inventory")
    printInv(index)             #This prints the inventory of the character
    print("")
    item_remove = input("Which item would you like to remove?: ")       #ask what we want to remove
    item_remove = item_remove.lower()                                   #make sure the input is lowercase
    all_tuples[index].remove(item_remove)                               #remove the item from the inventory
    print("")
...
while (choice != 5):
    ...
    print("5: Quit")
    print("")
    choice = int(input("What would you like to do? Enter a 1 or a 2 or a 3 or a 4 or a 5: "))
    ...
    if(choice == 1):
        ...
        add_char()                              #use the add_char function to add a character
    elif(choice == 4):
        remove_item()                           #user the remove item function to remove an item
    print("")
