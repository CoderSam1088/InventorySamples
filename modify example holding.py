...
while (choice != 7):
    ...
    print("7: Quit")
    print("")
    choice = input("What would you like to do? Enter a 1 or a 2 or a 3 or a 4 or a 5 or 6: ")
    while True:
        try:
            choice = int(choice)
            if (choice <= 7 and choice >= 1):
                ...
                choice = input("Invalid input. Enter a 1 or a 2 or a 3 or a 4 or a 5 or a 6: ")
        except:
            choice = input("Invalid input. Enter a 1 or a 2 or a 3 or a 4 or a 5 or a 6: ")
    ...
    if(choice == 1):
        ...
        index = choose_char()
        print("")
        print(printHolding(index))
    elif(choice == 6):
        index = choose_char()                   #choose a character
        print("")
